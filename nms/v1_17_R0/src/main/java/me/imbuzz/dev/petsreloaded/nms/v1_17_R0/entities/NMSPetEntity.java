package me.imbuzz.dev.petsreloaded.nms.v1_17_R0.entities;
...
import me.imbuzz.dev.petsreloaded.nms.v1_17_R0.goals.PathFinderGoalPetsBasic;
...
public class NMSPetEntity extends EntitySheep {
    ...
    public NMSPetEntity(PetEntity petEntity, Entity owner, double speed) {
        ...
        bO = new PathfinderGoalSelector(t.getMethodProfilerSupplier());
        bP = new PathfinderGoalSelector(t.getMethodProfilerSupplier());

        bO.a(0, new PathfinderGoalLookAtPlayer(this, EntityHuman.class, 8.0F));
        bO.a(1, new PathFinderGoalPetsBasic(petEntity, this, speed, (float) ((EntitySettings) petEntity.getPetSettings()).getDistanceInBlock(), 2.3F));
