package me.imbuzz.dev.petsreloaded.nms.v1_19_3_R0_1;
...
import me.imbuzz.dev.petsreloaded.nms.v1_19_3_R0_1.entities.NMSPetEntity;
...
public class EntityHandler implements IEntityHandler {
    ...
    public void updatePetStatus(Entity entity, PetStatus... petStatuses) {
        ...
        for (PetStatus petStatus : petStatuses) {
            switch (petStatus) {
                case NO_AI: {
                    ((Mob) nmsEntity).goalSelector.removeAllGoals(goal -> true);
