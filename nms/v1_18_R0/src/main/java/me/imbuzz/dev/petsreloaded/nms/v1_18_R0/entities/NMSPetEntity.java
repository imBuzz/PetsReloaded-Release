package me.imbuzz.dev.petsreloaded.nms.v1_18_R0.entities;
...
import me.imbuzz.dev.petsreloaded.nms.v1_18_R0.goals.PathFinderGoalPetsBasic;
    ...
    public void travel(Vec3 vec3d) {
        if (isVehicle()) {
            ...
            if (entityliving != null) {
                ...
                if (onGround) {
                    try {
                        Field jump = LivingEntity.class.getDeclaredField("bo");
