package me.imbuzz.dev.petsreloaded.nms.v1_13_R1.goals;
...
public class PathFinderGoalPetsBasic extends PathfinderGoal {
    ...
    @Override
    public boolean b() {
        return !basicEntity.getNavigation().p() && petOwner.h(basicEntity) >= minDistance && distanceFromNavigation() <= minDistance;
    }

    @Override
    public void d() {
        petOwner = null;
        basicEntity.getNavigation().q();
    }
