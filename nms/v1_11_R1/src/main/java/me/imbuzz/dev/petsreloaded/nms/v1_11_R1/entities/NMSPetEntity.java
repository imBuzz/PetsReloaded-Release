package me.imbuzz.dev.petsreloaded.nms.v1_11_R1.entities;
...
import me.imbuzz.dev.petsreloaded.nms.v1_11_R1.goals.PathFinderGoalPetsBasic;
...
public class NMSPetEntity extends EntitySheep {
    ...
    public void g(float sideMot, float forMot) {
        if (!passengers.isEmpty()) {
            net.minecraft.server.v1_11_R1.Entity passenger = passengers.get(0);

            this.lastYaw = this.yaw = passenger.yaw;
            this.pitch = (passenger.pitch * 0.5F);
            setYawPitch(this.yaw, this.pitch);
            this.aP = this.aJ = this.yaw;
