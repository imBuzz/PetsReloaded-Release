package me.imbuzz.dev.petsreloaded.nms.v1_16_R1.entities;
...
import me.imbuzz.dev.petsreloaded.nms.v1_16_R1.goals.PathFinderGoalPetsBasic;
...
public class NMSPetEntity extends EntitySheep {
    ...
    public void f(Vec3D vec3d) {
        ...
        if (!passengers.isEmpty()) {
            ...
            double sideMot = entityliving.aY * ((float) pet.getSettings().getSpeed() / 3);
            double forMot = entityliving.ba * ((float) pet.getSettings().getSpeed() / 3);
