package me.imbuzz.dev.petsreloaded.nms.v1_9_R1;
...
import me.imbuzz.dev.petsreloaded.nms.v1_9_R1.entities.NMSPetEntity;
            ...
            switch (petStatus) {
                ...
                case INVISIBLE: {
                    if (entity instanceof LivingEntity) ((LivingEntity) entity)
                            .addPotionEffect(
                                    new PotionEffect(PotionEffectType.INVISIBILITY, Integer.MAX_VALUE, 1, false, false, null));
                    break;
                }
            }
        }
