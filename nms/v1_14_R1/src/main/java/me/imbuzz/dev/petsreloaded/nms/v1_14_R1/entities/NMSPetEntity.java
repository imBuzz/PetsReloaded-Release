package me.imbuzz.dev.petsreloaded.nms.v1_14_R1.entities;
...
import me.imbuzz.dev.petsreloaded.nms.v1_14_R1.goals.PathFinderGoalPetsBasic;
...
public class NMSPetEntity extends EntitySheep {
    ...
    public void e(Vec3D vec3d) {
        if (!passengers.isEmpty()) {
            ...
            double sideMot = entityliving.bb * ((float) pet.getSettings().getSpeed() / 3);
            double forMot = entityliving.bd * ((float) pet.getSettings().getSpeed() / 3);
            ...
            this.K = 1.0F;// The custom entity will now automatically climb up 1 high blocks
