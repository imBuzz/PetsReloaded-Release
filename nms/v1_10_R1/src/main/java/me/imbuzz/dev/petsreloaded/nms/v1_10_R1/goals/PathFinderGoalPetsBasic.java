package me.imbuzz.dev.petsreloaded.nms.v1_10_R1.goals;
...
public class PathFinderGoalPetsBasic extends PathfinderGoal {
    ...
    @Override
    public boolean b() {
        return !basicEntity.getNavigation().n() && petOwner.h(basicEntity) >= minDistance && distanceFromNavigation() <= minDistance;
    }
