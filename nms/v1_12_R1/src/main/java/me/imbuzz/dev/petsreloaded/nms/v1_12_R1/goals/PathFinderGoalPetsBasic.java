package me.imbuzz.dev.petsreloaded.nms.v1_12_R1.goals;
...
public class PathFinderGoalPetsBasic extends PathfinderGoal {
    ...
    @Override
    public boolean b() {
        return !basicEntity.getNavigation().o() && petOwner.h(basicEntity) >= minDistance && distanceFromNavigation() <= minDistance;
    }

    @Override
    public void d() {
        petOwner = null;
        basicEntity.getNavigation().p();
    }
